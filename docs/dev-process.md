...
- [ ] 불필요한 API 호출 없음 (TanStack Query 캐시 활용)
- [ ] 리스트 응답에 페이지네이션 적용
...
- [ ] API 클라이언트: `frontend/src/lib/api/client.ts` 사용
- [ ] 컴포넌트: shadcn/ui 컴포넌트 우선 활용
- [ ] 한국 주식 색상 관례: 상승=빨간색, 하락=파란색
...
- 초기 환경 설정 가이드 (KIS API, 텔레그램, 개발 도구, 환경변수)
- 프로젝트 시작 시 1회 수행 항목
