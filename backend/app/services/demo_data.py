...
def get_demo_strategies() -> list:
    ...
    return [
        ...
        },
        {
            ...
            "user_id": None,
            "params": [
                {"id": 11, "param_key": "rsi_max", "param_value": "65", "param_type": "float"},
            ],
            "created_at": _dt(30),
        },
        {
            ...
            "user_id": None,
            "params": [
                {"id": 12, "param_key": "beta_max", "param_value": "0.8", "param_type": "float"},
                {"id": 13, "param_key": "beta_period", "param_value": "60", "param_type": "int"},
                {"id": 14, "param_key": "momentum_min", "param_value": "0.0", "param_type": "float"},
                {"id": 15, "param_key": "rsi_max", "param_value": "60.0", "param_type": "float"},
            ],
            "created_at": _dt(30),
        },
        {
            ...
            "user_id": None,
            "params": [
                {"id": 16, "param_key": "market_momentum_period", "param_value": "60", "param_type": "int"},
                {"id": 17, "param_key": "stock_momentum_min", "param_value": "5.0", "param_type": "float"},
                {"id": 18, "param_key": "market_risk_off", "param_value": "-3.0", "param_type": "float"},
                {"id": 19, "param_key": "rsi_max", "param_value": "60.0", "param_type": "float"},
            ],
            "created_at": _dt(30),
        },
    ]
